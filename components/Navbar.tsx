...
import { LogOut, Home, User, Zap, Search, MessageCircle, PlusCircle, Heart } from 'lucide-react'
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                ...
                <Link
                  href="/pets"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-700 hover:bg-gradient-to-r hover:from-pink-50 hover:to-purple-50 hover:text-pink-600 transition"
                  title="Mis Mascotas"
                >
